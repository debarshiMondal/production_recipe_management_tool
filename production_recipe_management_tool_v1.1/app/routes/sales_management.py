...
def generate_bill():
    try:
        ...
        return jsonify({'success': True, 'billLink': url_for('static', filename=f'Outlets/{outlet}/Bills/Bill_{date}_{customer_name}.pdf')})
...
def generate_kot():
    try:
        ...
        return jsonify({'success': True, 'kotLink': url_for('static', filename=f'Outlets/{outlet}/KOTs/KOT_{date}_{bill_number}.pdf')})
    except Exception as e:
        return jsonify({'success': False, 'error': str(e)})
