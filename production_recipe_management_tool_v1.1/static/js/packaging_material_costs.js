document.addEventListener('DOMContentLoaded', function() {
    document.getElementById('packaging-material-costs-form').addEventListener('submit', submitForm);
...
function submitForm(event) {
    ...
    var action = '/sales-management/procurement-costs/packaging-material-costs/submit';
...
function updateCostTable() {
    ...
    var action = '/sales-management/procurement-costs/packaging-material-costs/update';
