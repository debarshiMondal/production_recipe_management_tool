document.addEventListener('DOMContentLoaded', function() {
    document.getElementById('outsourced-product-costs-form').addEventListener('submit', submitForm);
...
function submitForm(event) {
    ...
    var action = '/sales-management/procurement-costs/outsourced-product-costs/submit';
...
function updateCostTable() {
    ...
    var action = '/sales-management/procurement-costs/outsourced-product-costs/update';
