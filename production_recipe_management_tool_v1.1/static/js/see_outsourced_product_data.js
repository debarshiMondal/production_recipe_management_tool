...
function submitSeeDataForm(event) {
    ...
    var action = '/sales-management/procurement-costs/outsourced-product-costs/get-data';
...
function submitFindProductCostForm(event) {
    ...
    var form = event.target;
    var formData = new FormData(form);
    var action = '/sales-management/procurement-costs/outsourced-product-costs/find-product-cost';
