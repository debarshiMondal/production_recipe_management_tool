...
function submitSeeDataForm(event) {
    ...
    var action = '/sales-management/procurement-costs/packaging-material-costs/get-data';
...
function submitFindProductCostForm(event) {
    ...
    var form = event.target;
    var formData = new FormData(form);
    var action = '/sales-management/procurement-costs/packaging-material-costs/find-product-cost';
