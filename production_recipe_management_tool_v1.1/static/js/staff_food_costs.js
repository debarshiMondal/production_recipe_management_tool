document.addEventListener('DOMContentLoaded', function() {
    document.getElementById('staff-food-costs-form').addEventListener('submit', submitForm);
...
function submitForm(event) {
    ...
    var action = '/sales-management/procurement-costs/staff-food-costs/submit';
...
function updateCostTable() {
    ...
    var action = '/sales-management/procurement-costs/staff-food-costs/update';
